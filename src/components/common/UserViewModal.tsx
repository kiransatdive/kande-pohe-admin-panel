...
import { X, Loader2, User as UserIcon, MapPin, Heart, Camera, GraduationCap, Users, Star, Settings } from 'lucide-react';
...
const UserViewModal: React.FC<UserViewModalProps> = ({ userId, isOpen, onClose }) => {
  ...
  const InfoRow = ({ label, value }: { label: string, value: any }) => (
    <div className="flex flex-col mb-3">
      ...
      <span className="text-sm text-gray-800 font-medium bg-gray-50 p-2 rounded border border-gray-100 break-words">{value === null || value === '' ? 'N/A' : String(value)}</span>
    </div>
  );
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-6xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex justify-between items-center p-5 border-b border-gray-100 bg-gray-50/50 rounded-t-xl shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-800">Comprehensive User Details</h2>
                ...
                <div className="flex-1 w-full">
                  <div className="flex flex-wrap justify-between items-start gap-4 mb-2">
                    ...
                    <div className="flex gap-2">
                      <span className="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-full text-xs font-bold border border-emerald-100">
                        Profile {userData.profile_completion}% Complete
                      </span>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs font-medium border border-gray-200">
                      Status: {userData.status === 1 ? 'Active' : userData.status === 10 ? 'Pending' : userData.status}
                    </span>
                    <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs font-medium border border-gray-200">
                      Profile For: {userData.Profile_created_for || 'Self'}
                    </span>
                    <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs font-medium border border-gray-200">
                      Gender: {userData.Gender || 'N/A'}
                    </span>
                    <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs font-medium border border-gray-200">
                      Email Verified: {userData.eEmailVerifiedStatus}
                    </span>
                    <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs font-medium border border-gray-200">
                      Phone Verified: {userData.ePhoneVerifiedStatus}
                    </span>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    ...
                    <InfoRow label="Marital Status" value={userData.Marital_Status} />
                    <InfoRow label="Blood Group ID" value={userData.iBloodGroup_ID} />
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    ...
                    <InfoRow label="Annual Income ID" value={userData.iAnnualIncomeID} />
                  </div>
                </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    ...
                    <InfoRow label="Parents Residing" value={userData.vParentsResiding} />
                    <InfoRow label="Family Income ID" value={userData.iFamilyAnnualIncomeID} />
                    <InfoRow label="Inter-caste Parents" value={userData.vParentInterCasteMarriage} />
                    <InfoRow label="Living Separately" value={userData.vParentsLivingSeparately} />
                  </div>
                </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    <InfoRow label="Height ID" value={userData.iHeightID} />
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    ...
                    <InfoRow label="Religion ID" value={userData.iReligion_ID} />
                    <InfoRow label="Community ID" value={userData.iCommunity_ID} />
                    <InfoRow label="Sub Community" value={userData.iSubCommunity_ID} />
                    ...
                    <InfoRow label="Country (CA)" value={userData.iCountryCAId} />
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    ...
                    <InfoRow label="Gotra ID" value={userData.iGotraID} />
                    <InfoRow label="Raashi ID" value={userData.RaashiId} />
                    <InfoRow label="Nakshtra ID" value={userData.NakshtraId} />
                    <InfoRow label="Gan ID" value={userData.GanId} />
                    <InfoRow label="Charan ID" value={userData.CharanId} />
                    <InfoRow label="Nadi ID" value={userData.NadiId} />
                  </div>
                </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 flex-1">
                    <InfoRow label="Interests ID" value={userData.InterestID} />
                    <InfoRow label="Music ID" value={userData.FaviouriteMusicID} />
                    <InfoRow label="Read ID" value={userData.FavioriteReadID} />
                    <InfoRow label="Cousines ID" value={userData.FavouriteCousinesID} />
                    <InfoRow label="Sports ID" value={userData.SportsFittnessID} />
                    <InfoRow label="Movies ID" value={userData.PreferredMovieID} />
                    <InfoRow label="Dress ID" value={userData.PreferredDressID} />
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col lg:col-span-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 flex-1">
                    ...
                    <InfoRow label="Privacy Option" value={userData.user_privacy_option} />
                    <InfoRow label="Hide Profile" value={userData.hide_profile} />
                    <InfoRow label="Phone Privacy" value={userData.phone_privacy} />
                    <InfoRow label="Photo Privacy" value={userData.photo_privacy} />
                    <InfoRow label="Visitor Setting" value={userData.visitor_setting} />
